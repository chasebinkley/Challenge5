// using moment to display exact current month, day, and year //
var nMoment = moment().format("MMMM Do YYYY");
var display = $("#currentDay");
display.text(nMoment);

// pulls and selects the current hour in a 24 hour clock //
var cal = new Date();
...
$(document).ready(function () {
  ...
  // grabbing values from local storage and renders them to their specific time-block so they stay after page refresh //
